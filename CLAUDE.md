...
| `scripts/`                                         | exactly five externally-pinned files — see `scripts/README.md`                                                                   |
...
| `scripts/` holds five invocable files, the shims forward rather than re-export, and `.prettierignore` entries are contracts                                                                                 | `tests/quality/structure.test.mjs`, `tests/quality/shims.test.mjs`, `tests/quality/format.test.mjs` |
