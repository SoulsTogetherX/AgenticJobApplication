...
| **Field cache**           | `jobs/.field-cache.json`                                     | `fill-plan.mjs` (`saveCache`, `recordVia`)                                                                                                   | `pending-questions.mjs`, `automatability.mjs`, `bench-green-prevalence.mjs`                                       | re-derivable — the next scan re-probes, slowly            |
