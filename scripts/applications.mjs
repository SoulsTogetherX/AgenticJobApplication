...
//   node scripts/applications.mjs remove <slug> --confirm
//   node scripts/applications.mjs export
//
// Creating and updating entries stay where they were:
//   node scripts/log-application.mjs <slug> --company X --title Y
//   node scripts/update-application.mjs <slug> --status s [--followed-up]
import { pathToFileURL } from "node:url"
import path from "node:path"
import { isTerse, dumpYaml } from "./lib.mjs"
import {
  openDb,
  readApplications,
  deleteApplication,
