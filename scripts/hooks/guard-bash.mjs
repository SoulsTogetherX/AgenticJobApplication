// FORWARDING SHIM — the real hook moved to src/hooks/guard-bash.mjs in the
...
const target = new URL("../../src/hooks/guard-bash.mjs", import.meta.url)
process.argv[1] = fileURLToPath(target)
process.stderr.write("[shim] scripts/hooks/guard-bash.mjs -> src/hooks/\n")
