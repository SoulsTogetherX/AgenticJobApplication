// FORWARDING SHIM — the real hook moved to src/hooks/prettify.mjs in the
...
const target = new URL("../../src/hooks/prettify.mjs", import.meta.url)
process.argv[1] = fileURLToPath(target)
process.stderr.write("[shim] scripts/hooks/prettify.mjs -> src/hooks/\n")
