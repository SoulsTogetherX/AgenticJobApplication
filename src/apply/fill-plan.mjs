...
// every field through src/apply/answer-bank.mjs (profile + answer bank only), and
// writes:
//   jobs/<slug>/fill-plan.js    -- a self-contained bootstrap: this job's plan
//                                  AND the src/apply/fill-engine.mjs source
...
//
// Usage: node src/apply/fill-plan.mjs <slug> [--scan <path> | --page <N>]
...
// src/lib/untrusted.mjs, wired here). An answer bank entry is either a
...
// none of it — src/apply/browser.mjs simply imports the same module.
//
...
`
    : ""
  return `// Generated by src/apply/fill-plan.mjs — do not edit by hand.
async (page) => {
  // Both constants below were read/built in an ordinary Node process (this
  // file's generator, src/apply/fill-plan.mjs), never in here — the
...
${installScanner}  // One eval, of a string that came off OUR OWN DISK. The engine is never put
  ...
  //   node src/apply/fill-plan.mjs <slug> --record-via <that file>
...
function main() {
  ...
  //
  // engineSandboxSource() reads src/apply/fill-engine.mjs and translates it
