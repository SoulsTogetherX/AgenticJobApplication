...
import { buildPlan, isConsent } from "../scripts/fill-plan.mjs"
import { detectAts, ADAPTERS } from "../scripts/ats/index.mjs"
import greenhouse from "../scripts/ats/greenhouse.mjs"
...
test("a question about the name is not answered with the name", async () => {
  ...
  const { resolveFields } = await import("../scripts/fill-plan.mjs")
